...
features:
  ...
  - icon: 🔀
    ...
    details: When two personas collide on the same verified identity, persona-kit resolves it with a preview-then-confirm merge — the one step every hosted auth hands back to your app.
  - icon: 📦
